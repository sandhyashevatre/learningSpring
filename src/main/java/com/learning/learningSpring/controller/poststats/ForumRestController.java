...
import com.learning.learningSpring.service.CommentService;
...
public class ForumRestController {
    ...
    public ResponseEntity<String> addComment(@RequestBody CommentDTO commentDTO) {
        ...
        User user = userService.findUserByName("sandhya").get();
    ...
    // public ResponseEntity<?> addTagsToPost(@PathVariable int id, @RequestBody
    ...
    // return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No post with the
    // requested ID");
    // }
    ...
    @PostMapping("/post")
    public ResponseEntity<?> createNewPost(@RequestBody AddPostForm postForm,
            @AuthenticationPrincipal UserDetails userDetails) {
    ...
    // Other REST endpoints for updating, deleting, and other operations can be
    // added similarly.
